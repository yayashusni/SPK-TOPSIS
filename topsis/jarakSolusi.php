...
?>
<h3 class="mt-4">Jarak Solusi Ideal Positif & Negatif</h3>

    <h5>Jarak Solusi Ideal Positif (D<sup>+</sup>)</h5>
...
while($da2=mysqli_fetch_assoc($a2)){
		...
		while($dn2=mysqli_fetch_assoc($n2)){
			...
			$v2=number_format(($dn2['nilai']/sqrt($nilai_kuadrat2))*$bot2,4);
...
*/    
		...
		$dpreferensi[$ii]=number_format($final,4);
...
<!-- tabel min ------------------------------------------------->
    ...
    <h5>Jarak Solusi Ideal Negatif (D<sup>-</sup>)</h5>
<div class="table-responsive">
<table class="table table-bordered table-bordered-bd-primary">
<thead>
<tr>
